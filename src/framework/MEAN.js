 ...
 * # MEAN.js
 *
 * This class interfaces with LivHea API using the rest api
...
export default class MEAN extends Backend{
  /**
   * ## Hapi.js client
   *
   *
  ...
  constructor( token) {
    ...
    this.API_BASE_URL= CONFIG.backend.meanDev ?
      CONFIG.MEAN.development.url : CONFIG.MEAN.production.url;
  }
  /**
   * ### signup
   *
